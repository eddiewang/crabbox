...
- Simplified WSL2 SSH execution into one verified SFTP envelope with bounded transfer, identity-checked cleanup, and no replay after publication uncertainty. Thanks @vincentkoc.
